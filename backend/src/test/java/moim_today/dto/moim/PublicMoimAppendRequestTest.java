...
class PublicMoimAppendRequestTest {
    ...
    void NoneImageUrlCreateEntityWithDefaultUrl() {
        ...
        PublicMoimAppendRequest publicMoimAppendRequest = PublicMoimAppendRequest.builder()
                .title(TITLE.value())
        ...
        //when
        MoimJpaEntity entity = publicMoimAppendRequest.toEntity(memberId, universityId);
