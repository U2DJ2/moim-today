...
export default function Schedule() {
    ...
    return (
        <>
            <Modal show={openTodoAddModal} size="xl" onClose={() => setOpenTodoAddModal(false)} theme={modalTheme}>
                    ...
                    <div className="flex w-full flex-col gap-4">
                        ...
                        <div>
                            <div className="mb-2 block">
                                <Label className='font-Pretendard_SemiBold' htmlFor="base" value="TODO 내용" />
                            </div>
                            <TextInput id="base" type="text" sizing="md" theme={textInputTheme} />
                        </div>
                        <div>
            ...
            <div className="justify-between pt-6 bg-white flex flex-col">
                <div className="flex w-full max-md:flex-col max-md:gap-0">
                    <Sidebar onDateChange={handleMiniCalendarDateSelect} setOpenTodoAddModal={setOpenTodoAddModal} />
