...
function SearchBar() {
  return (
    <div className="flex flex-col justify-center mt-2 text-zinc-900 text-opacity-60 max-md:max-w-full">
      <form className="flex gap-3 px-5 py-5 bg-zinc-50 bg-opacity-90 rounded-[40px] max-md:flex-wrap">
        <label htmlFor="search" className="sr-only">Search</label>
        <button type="submit" className="justify-center px-1.5 py-1.5 text-lg font-medium text-center leading-[12px]">
          􀊫
        </button>
        <input
          type="text"
          id="search"
          placeholder="Search"
          className="flex-1 my-auto text-lg tracking-tight leading-6 max-md:max-w-full outline-none bg-zinc-50"
          aria-label="Search"
        />
      </form>
    </div>
